...
public class Configurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        //         .permiteAll()
        //         .anyRequest().authenticated().and().build(); // Todas as outras URL precisarão de autenticação
    ...
    // Necessário para a classe AuthenticationManager lá do AuthController saber injetar
    @Bean
